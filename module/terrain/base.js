...
YUI.add('terrain-base', function(Y) {

/**
 * 地型类
 * @module terrain
 * @submodule terrain-base
 *
 */
...
Y.extend(Terrain, Y.Base, {
    ...
    initMap: function(){
        ...
        this.field.add((new Unit.Ground(mapData)).entity);
        ...
        test.afterLoad(function(){
            self.field.add(test.entity);
            test.setPos(50, 0, 50);
        });

        var test1 = new Unit.Test();
        test1.id = 'test1';
        test1.afterLoad(function(){
            self.field.add(test1.entity);
            test1.setPos(60, 0, 50);
        });

        var test2 = new Unit.Test();
        test2.id = 'test2';
        test2.afterLoad(function(){
            self.field.add(test2.entity);
            test2.setPos(40, 0, 50);
        });
    },
